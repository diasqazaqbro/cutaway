				...
				<div class='accordion-item' style={{ background: '#121212' }}>
					...
					>
						...
						>
							...
							Дизайн (небольшой UI Kit) создан в Figma, сайт разработан
							использованием Next.js
							<div
								class='accordion__footer my-3'
								style={{ borderTop: '1px solid #3e4041', paddingTop: 10 }}
							>
								<a
				...
				<div class='accordion-item' style={{ background: '#121212' }}>
					...
					>
						...
						>
							...
							впихнуть логику на фронт часть, но это был интересный опыт.
							<div
								class='accordion__footer my-3'
								style={{ borderTop: '1px solid #3e4041', paddingTop: 10 }}
							>
								<a
									href='https://topecar.kz'
									type='button'
									class='rounded-pill btn btn-primary'
								>
									<svg
